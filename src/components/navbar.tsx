    ...
    <nav className="fixed top-0 left-0 right-0 z-[9999] bg-black/95 backdrop-blur-md border-b border-yellow-500/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <Button className="bg-yellow-400 hover:bg-yellow-500 text-blue-950 font-geist font-bold border-0">
              Получить карту
            </Button>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-yellow-500/20">
              ...
              <div className="px-3 py-2">
                <Button className="w-full bg-yellow-400 hover:bg-yellow-500 text-blue-950 font-geist font-bold border-0">
                  Получить карту
                </Button>
              </div>
            </div>
